...
const buttonVariants = cva(
	"font-medium transition-button duration-200 ease-in-out tracking-wide text-center ",
	{
		variants: {
			variant: {
				default: "bg-primary text-primary-foreground hover:bg-[#5e5be9]",
				outline:
			...
			size: {
				default: "px-6 py-2 text-base rounded-[24px]",
				sm: "px-4 py-2 text-sm rounded-[24px]",
				lg: "px-8 py-3 rounded-[24px]",
				icon: "inline-flex justify-center items-center h-9 w-9 md:h-11 md:w-11 rounded-full",
			},
		},
		defaultVariants: {
			variant: "default",
