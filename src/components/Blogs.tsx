...
const insights = [
    {
        title: "Why Startups?",
        description: "I thrive in high-velocity environments where innovation is the baseline. Working with early-stage founders allows for the kind of rapid iteration and bold thinking that defines my engineering philosophy.",
    },
    {
        title: "What I Build",
        description: "Specializing in the intersection of scalable full-stack architecture and intelligent automation. I leverage Next.js, Go, and Python to turn complex requirements into clean, production-ready systems.",
    },
    {
        title: "How I Help",
        description: "From architecting MVPs to deploying deep-learning recommendation engines—I bridge the gap between abstract ideas and functional digital products that solve real-world problems.",
    },
    {
        title: "Let’s Talk",
        description: "Currently open to new collaborations and technical consulting. If you have an idea that needs a structured, scalable foundation, let’s build the future together.",
        href: "/contact",
    },
];
