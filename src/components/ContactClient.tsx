				...
				<div className="col-span-12 lg:col-span-6 space-y-12">
					<div className="space-y-6">
						...
						<div className="space-y-4">
							<p className="text-xl md:text-2xl font-light break-all sm:break-normal">
								<a
					...
					<div className="font-mono text-[8px] sm:text-[9px] tracking-[0.12em] sm:tracking-[0.35em] text-[#8C8680] leading-loose">
