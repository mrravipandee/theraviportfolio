					...
					<div className="space-y-16">
						...
						<div className="relative pl-8">
							...
							<p className="text-sm font-light md:text-lg text-[#4a4a4a] leading-relaxed max-w-md be-vietnam">
								To bridge the digital divide by providing seamless access to
								internet and AI technologies for those left behind. We strive to
								empower every individual with the tools needed to thrive in this
								era of rapid innovation.
							</p>
						</div>
						...
						<div className="relative pl-8">
							...
							<p className="text-sm font-light md:text-lg text-[#4a4a4a] leading-relaxed max-w-md be-vietnam">
								To craft systems that endure and empower. We aim to build
								human-centric solutions that redefine connectivity, foster
								lifelong learning, and transform creative passion into scalable
								digital realities.
							</p>
						</div>
					</div>
