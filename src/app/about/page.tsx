                ...
                <div className="col-span-12 md:col-span-7 md:pl-12">
                    ...
                    <div className="space-y-6 max-w-xl">
                        <p className="text-lg md:text-xl text-[#1A1A1A] font-medium leading-tight be-vietnam">
                            I&apos;m Ravii Pandey, a Full-Stack Developer and Machine Learning enthusiast based in Nashik, India.
                        </p>
                        
                        <p className="text-sm md:text-base text-[#4a4a4a] leading-relaxed font-light be-vietnam">
                            I thrive on helping startups scale by simplifying complex technology. Whether it&apos;s crafting seamless web experiences with React and Node.js or unlocking AI possibilities with NLP, I’m committed to building tools that transform ideas into scalable digital realities.
                        </p>
                    </div>
