    ...
    <section className="view-container mt-32 mb-40 px-6 md:px-10">
      ...
      <div className="flex flex-col gap-24">
        {projects.map((project, index) => (
          <div key={index} className="group flex flex-col md:flex-row gap-10 md:gap-20 items-start">
            ...
            <div className="w-full md:w-1/3 space-y-6 order-2 md:order-1">
              ...
              <div className="pt-6 flex gap-8 text-[11px] font-bold uppercase tracking-widest">
                <Link href={project.liveLink || "#"} target="_blank" className="border-b border-black pb-1 hover:opacity-50 transition-opacity">
                  Live View
                </Link>
                <Link href={project.sourceLink || "#"} target="_blank" className="border-b border-black/20 pb-1 hover:border-black transition-all">
                  GitHub
                </Link>
              </div>
            </div>
